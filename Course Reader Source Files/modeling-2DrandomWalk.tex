...
\node at (1.5,1.5) {\huge$P=\frac{1}{5}$};
\node at (-1.5,1.5) {\huge$P=\frac{1}{5}$};
\node at (1.5,-1.5) {\huge$P=\frac{1}{5}$};
\node at (1.5,4.5) {\huge$P=\frac{1}{5}$};
\node at (4.5,1.5) {\huge$P=\frac{1}{5}$};
...
Finally we consider the case where the particle does not move at all.
\begin{align*}
